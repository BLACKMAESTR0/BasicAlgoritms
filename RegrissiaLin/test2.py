...
for i in range(1000000):
    ...
    listOfPogresh.append(FuncOfOshibok.RMSE([coord[x][0]*nachTg+nachOtkl for x in range(len(coord))],[coord[x][1] for x in range(len(coord))]))
    if len(listOfPogresh) > 100 and abs(listOfPogresh[i] - listOfPogresh[i-100]) < 0.00000001:
        print(i)
        break
